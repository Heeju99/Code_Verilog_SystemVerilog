...
module fnd_controller(
    ...
    wire [1:0] w_seg_sel;
    wire [3:0] w_digit_1, w_digit_10, w_digit_100, w_digit_1000, w_bcd, w_digit_1_1, w_digit_10_1;
    wire clk_100hz;
    ...
    digit_splitter1 U_Digit_splitter1(
        .c60(c60), 
        //.digit_1(w_digit_1_1), 
        //.digit_10(w_digit_10_1) 
        .digit_100(w_digit_1_1), 
        .digit_1000(w_digit_10_1)
    );
...
assign digit_1 = c100 % 10; //10의 1의 자리
assign digit_10 = c100 / 10 % 10; //10의 10의 자리
...
//assign digit_1 = c60 % 10; //10의 1의 자리
//assign digit_10 = c60 / 10 % 10; //10의 10의 자리
assign digit_100 = c60 / 100 % 10; //10의 100의 자리
assign digit_1000 = c60 / 1000 % 10; //10의 1000의 자리
