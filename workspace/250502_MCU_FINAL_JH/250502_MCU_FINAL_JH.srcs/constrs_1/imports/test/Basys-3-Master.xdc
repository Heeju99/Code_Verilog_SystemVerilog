...
# set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports {GPIOD[12]}]
# set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports {GPIOD[13]}]
# set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {GPIOD[14]}]
# set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {GPIOD[15]}]
...
# set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports INOUTDHT11];#Sch name = JC10
...
# set_property -dict { PACKAGE_PIN N1   IOSTANDARD LVCMOS33 } [get_ports INOUTDHT11];#Sch name = XA4_N
